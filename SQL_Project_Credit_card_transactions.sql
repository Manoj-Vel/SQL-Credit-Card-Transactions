...
--it reaches a cumulative of 1000000 total spends(4 rows in the o/p one for each card type)
...
--5- Print 3 columns with as case of: city, highest_expense_type, lowest_expense_type (format : Delhi , bills, Fuel)
...
--6- Percentage contribution of spends by gender female for each expense type
